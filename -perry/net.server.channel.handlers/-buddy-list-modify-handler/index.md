...
---
//[Perry](../../../index.html)/[net.server.channel.handlers](../index.html)/[BuddyListModifyHandler](index.html)
...
[jvm]\
class [BuddyListModifyHandler](index.html) : [AbstractPacketHandler](../../net/-abstract-packet-handler/index.html)
...
| [nextPendingRequest](next-pending-request.html) | [jvm]<br>fun [nextPendingRequest](next-pending-request.html)(c: [Client](../../client/-client/index.html)) |
