...
---
//[Perry](../../../index.html)/[net.server.channel.handlers](../index.html)/[UseItemHandler](index.html)
...
[jvm]\
class [UseItemHandler](index.html) : [AbstractPacketHandler](../../net/-abstract-packet-handler/index.html)
...
| [remove](remove.html) | [jvm]<br>fun [remove](remove.html)(c: [Client](../../client/-client/index.html), slot: [Byte](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-byte/index.html)) |
