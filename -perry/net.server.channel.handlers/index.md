---
title: net.server.channel.handlers
---
//[Perry](../../index.html)/[net.server.channel.handlers](index.html)
...
| Name | Summary |
|---|---|
| [AbstractDealDamageHandler](-abstract-deal-damage-handler/index.html) | [jvm]<br>abstract class [AbstractDealDamageHandler](-abstract-deal-damage-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [AbstractMovementPacketHandler](-abstract-movement-packet-handler/index.html) | [jvm]<br>abstract class [AbstractMovementPacketHandler](-abstract-movement-packet-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [AdminChatHandler](-admin-chat-handler/index.html) | [jvm]<br>open class [AdminChatHandler](-admin-chat-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [AdminCommandHandler](-admin-command-handler/index.html) | [jvm]<br>class [AdminCommandHandler](-admin-command-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [AdminLogHandler](-admin-log-handler/index.html) | [jvm]<br>class [AdminLogHandler](-admin-log-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [AutoAggroHandler](-auto-aggro-handler/index.html) | [jvm]<br>class [AutoAggroHandler](-auto-aggro-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [AutoAssignHandler](-auto-assign-handler/index.html) | [jvm]<br>open class [AutoAssignHandler](-auto-assign-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [BBSOperationHandler](-b-b-s-operation-handler/index.html) | [jvm]<br>class [BBSOperationHandler](-b-b-s-operation-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [BeholderHandler](-beholder-handler/index.html) | [jvm]<br>class [BeholderHandler](-beholder-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [BuddyListModifyHandler](-buddy-list-modify-handler/index.html) | [jvm]<br>class [BuddyListModifyHandler](-buddy-list-modify-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [CancelBuffHandler](-cancel-buff-handler/index.html) | [jvm]<br>class [CancelBuffHandler](-cancel-buff-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html), [PacketHandler](../net/-packet-handler/index.html) |
| [CancelChairHandler](-cancel-chair-handler/index.html) | [jvm]<br>class [CancelChairHandler](-cancel-chair-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [CancelDebuffHandler](-cancel-debuff-handler/index.html) | [jvm]<br>class [CancelDebuffHandler](-cancel-debuff-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [CancelItemEffectHandler](-cancel-item-effect-handler/index.html) | [jvm]<br>class [CancelItemEffectHandler](-cancel-item-effect-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [CashOperationHandler](-cash-operation-handler/index.html) | [jvm]<br>class [CashOperationHandler](-cash-operation-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [ChangeChannelHandler](-change-channel-handler/index.html) | [jvm]<br>class [ChangeChannelHandler](-change-channel-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [ChangeMapHandler](-change-map-handler/index.html) | [jvm]<br>class [ChangeMapHandler](-change-map-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [ChangeMapSpecialHandler](-change-map-special-handler/index.html) | [jvm]<br>class [ChangeMapSpecialHandler](-change-map-special-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [CharInfoRequestHandler](-char-info-request-handler/index.html) | [jvm]<br>class [CharInfoRequestHandler](-char-info-request-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [ClickGuideHandler](-click-guide-handler/index.html) | [jvm]<br>open class [ClickGuideHandler](-click-guide-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [CloseChalkboardHandler](-close-chalkboard-handler/index.html) | [jvm]<br>class [CloseChalkboardHandler](-close-chalkboard-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [CloseRangeDamageHandler](-close-range-damage-handler/index.html) | [jvm]<br>class [CloseRangeDamageHandler](-close-range-damage-handler/index.html) : [AbstractDealDamageHandler](-abstract-deal-damage-handler/index.html) |
| [CoconutHandler](-coconut-handler/index.html) | [jvm]<br>class [CoconutHandler](-coconut-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [CouponCodeHandler](-coupon-code-handler/index.html) | [jvm]<br>class [CouponCodeHandler](-coupon-code-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [DamageSummonHandler](-damage-summon-handler/index.html) | [jvm]<br>class [DamageSummonHandler](-damage-summon-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [DenyGuildRequestHandler](-deny-guild-request-handler/index.html) | [jvm]<br>class [DenyGuildRequestHandler](-deny-guild-request-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
| [DenyPartyRequestHandler](-deny-party-request-handler/index.html) | [jvm]<br>class [DenyPartyRequestHandler](-deny-party-request-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
...
| [EnterCashShopHandler](-enter-cash-shop-handler/index.html) | [jvm]<br>open class [EnterCashShopHandler](-enter-cash-shop-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
...
| [ItemPickupHandler](-item-pickup-handler/index.html) | [jvm]<br>class [ItemPickupHandler](-item-pickup-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
...
| [MovePetHandler](-move-pet-handler/index.html) | [jvm]<br>class [MovePetHandler](-move-pet-handler/index.html) : [AbstractMovementPacketHandler](-abstract-movement-packet-handler/index.html) |
...
| [SummonDamageHandler](-summon-damage-handler/index.html) | [jvm]<br>class [SummonDamageHandler](-summon-damage-handler/index.html) : [AbstractPacketHandler](../net/-abstract-packet-handler/index.html) |
