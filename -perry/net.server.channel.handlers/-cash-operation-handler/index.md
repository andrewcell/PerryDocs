---
title: CashOperationHandler
---
//[Perry](../../../index.html)/[net.server.channel.handlers](../index.html)/[CashOperationHandler](index.html)



# CashOperationHandler



[jvm]\
class [CashOperationHandler](index.html) : [AbstractPacketHandler](../../net/-abstract-packet-handler/index.html)
...
| Name | Summary |
|---|---|
| [canBuy](can-buy.html) | [jvm]<br>open fun [canBuy](can-buy.html)(item: [Cashshop.CashItem](../../server/-cashshop/-cash-item/index.html), cash: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)): [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html) |
